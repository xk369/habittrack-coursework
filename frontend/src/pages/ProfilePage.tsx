...
import { Button, Card, Input, PageTitle, RoleBadge, Skeleton, StatusBadge } from '../shared/ui/primitives';
...
export function ProfilePage() {
  ...
  return (
    <div className="space-y-6">
      <PageTitle eyebrow="Профиль" title="Учетная запись" description="Основные данные и текущий доступ." />
      <Card className="max-w-2xl p-5">
        ...
        <form className="mt-6 space-y-4" onSubmit={handleSubmit((values) => mutation.mutate(values))}>
          <label className="block">
            <span className="mb-2 block text-sm font-medium">Отображаемое имя</span>
