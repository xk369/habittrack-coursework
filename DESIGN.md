...
description: "A gentle productivity workspace for habit metrics: pistachio neutrals, calm hierarchy, compact cards, tabular numbers, and visible progress states."
colors:
  primary: "#668b6f"
  primary-hover: "#54785d"
  on-primary: "#ffffff"
  canvas: "#f4f8f1"
  canvas-tint: "#ecf3e8"
  surface-card: "#fffefc"
  surface-inset: "#eaf2e8"
  surface-ink: "#25352a"
  ink: "#25352a"
  ink-muted: "#607064"
  ink-subtle: "#829082"
  hairline: "#d7e3d4"
  hairline-strong: "#b8ccb8"
  success: "#557e61"
  warning: "#a97935"
  danger: "#b35d58"
typography:
...
Use a warm neutral canvas with white work surfaces and a pistachio product accent. The sage accent should appear on the main CTA, selected states, progress fills, and focus rings. Amber is reserved for warnings or streak emphasis; red is reserved for destructive actions and blocked accounts. Muted text must remain readable against tinted surfaces.
...
The app uses a collapsible desktop sidebar plus a mobile navigation that stays in the page flow. Main content sits in a 7xl max-width workspace with 24-32px desktop padding and 16px mobile padding. Dashboards favor compact grids, progress bars, and metric tiles over hero-sized marketing sections.
...
Buttons, cards, inputs, panels, and tabs use a soft 8-14px radius scale. Pills are reserved for badges and progress/status chips. This keeps the app work-focused while removing sharp block corners.
...
- Do use pistachio sage for the main action and progress only.
...
At desktop widths, keep a compact or expanded sidebar available and content dense. At tablet/mobile widths, move navigation into the normal page flow and let grids become one column. Metric tiles should not shrink text below readability; tables should switch to cards or remain inside contained overflow. No screen should create horizontal page overflow.
